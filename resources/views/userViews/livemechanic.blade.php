...
<body>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/livemechanic.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
          <h1 class="logo"><a href="index.html">LIVE <span>MECHANICS</span></a></h1>
            <p class="font-italic">
            POWERFULL MECH SOLUTION WITH BULLET CLUB
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> We are providing genuine accessories and spare parts</li>
              <li><i class="ri-check-double-line"></i> We accept all type polishing,painting and re modeling works</li>
              <li><i class="ri-check-double-line"></i> We are introducing live service with riders freindly</li>
            </ul>
            <p>
             The club which provide POWERFUL MECH  Solution for riders.All types of tyre works,painting,polishing,remodeling,accessories and spares are accept and we wil provide the service with the genuineity and rider freindly.This is the exact club for the mech solution of ROYAL ENFIELD !
            </p>
          </div>
        </div>
 ...
 <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>BULLET</span></strong>CLUB All Rights Reserved
      </div>
      <div class="credits">
